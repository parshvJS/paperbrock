...
function Email() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const notify = () => toast.success("You Are Added To Beta !", {
                position: "top-center",
                autoClose: 5000,
                hideProgressBar: false,
                closeOnClick: true,
            ...
            giveToast("You Please Try Again After Some Time !")
            console.error(error);
        } finally {
            setLoading(false);
            setEmailAddress("");
    ...
    const handleButtonClick = (e) => {
        if (emailAddress === "") {
            setValidEmail(false);
            giveToast("Please Enter Email To Register !");
             // Empty email
            return;
        }
        if (!isValidEmail(emailAddress)) {
            setValidEmail(false); // Invalid email format
            giveToast("Please Enter Valid Email !")
            return;
        }
